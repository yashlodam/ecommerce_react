...
function DeactivatedAccount() {
  ...
  return (
    <Box className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50 flex items-center justify-center p-5">
      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-orange-500 to-amber-500 px-10 py-10 text-white">
          ...
          <div className="relative">
            ...
            <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-lg flex items-center justify-center shadow-lg animate-pulse">

              <PauseCircleFilledRoundedIcon sx={{ fontSize: 48 }} />
        ...
        <div className="p-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-8">
            ...
            {[
              ...
              <div
                key={item}
                className="flex items-center gap-3 rounded-xl bg-slate-50 hover:bg-orange-50 transition-all duration-300 p-4"
              >
                <InfoRoundedIcon
                  sx={{
                    color: "#ea580c",
          ...
          <Paper
            variant="outlined"
            className="rounded-2xl p-6 mt-8 bg-orange-50 border-orange-200"
          >
